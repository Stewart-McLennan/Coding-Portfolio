...
if exist('invertYN', 'var') == 1 && isempty(invertYN) == 0 && ...
        ischar(invertYN) == 1 && (strncmpi(invertYN, 'y', 1) == 1 || ...
        strncmpi(invertYN, 'i', 1) == 1)
...
if nargout == 2
  ...
  while min(checkedlist) == 0
    ...
    sameX = coordVERTICES(:, 1, :) == coordVERTICES(startfacet, 1, ...
        edgepointA);
    sameY = coordVERTICES(:, 2, :) == coordVERTICES(startfacet, 2, ...
        edgepointA);
    sameZ = coordVERTICES(:, 3, :) == coordVERTICES(startfacet, 3, ...
        edgepointA);
    ...
    if numel(matchfacet) ~= 1
      ...
      if checkedlist(matchfacet) == 0 && waitinglist(matchfacet) == 0
        ...
        if matchpointB - matchpointA == 1 || matchpointB - matchpointA ...
                == -2
          %Direction needs to be flipped

          [coordVERTICES(matchfacet, :, matchpointA), ...
              coordVERTICES(matchfacet, :, matchpointB)] = ...
              deal(coordVERTICES(matchfacet, :, matchpointB), ...
              coordVERTICES(matchfacet, :, matchpointA));
